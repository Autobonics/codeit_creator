...
class OutputFunctionWithParameterCanvasElement extends StatefulWidget {
  ...
  @override
  State<OutputFunctionWithParameterCanvasElement> createState() =>
      _OutputFunctionWithParameterCanvasElementState();
}

class _OutputFunctionWithParameterCanvasElementState
    extends State<OutputFunctionWithParameterCanvasElement> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return CreatorCanvasElement(
      ...
      childBuilder: (data, isPressedDown) {
        return OutputFunctionWithParameterElement(
          data: data,
          controller: widget.controller,
        );
      },
